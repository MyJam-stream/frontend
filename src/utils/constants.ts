...
export const RoadmapPassedItems: RoadmapItemProps[] = [
  {
    title: 'MyJam started',
    description:
      'During ETHOnline 2023 hackathon, we started with the goal of empowering musicians with web3 techs.',
  },
  {
    title: 'Supported by SheFi Grants',
    description:
      'On November 2023, we have draw lots of recognition and support from SheFi community and SheFi GG19 Round.',
  },
]
